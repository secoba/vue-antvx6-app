    ...
    <div class="wrap">
      <el-form label-width="80px">
        <el-form-item label="节点名称">
          <el-input v-model="nodeData.name" placeholder="请输入节点名称" @blur="inputBlur"></el-input>
        </el-form-item>
        <el-form-item label="节点描述">
          <el-input type="textarea" v-model="nodeData.desc" placeholder="请输入节点描述" @blur="inputBlur2"></el-input>
        </el-form-item>
      </el-form>
    </div>
  </div>
